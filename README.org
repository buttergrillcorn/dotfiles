...
- *Mod + Shift + M*: Notification actions menu (invoke, dismiss, dismiss all, list, restore)
...
- =~/.local/bin/mako-actions= - Interactive fuzzel menu for mako notification actions
  ...
  - Usage: Mod+Shift+M to open menu with options to invoke, dismiss, dismiss all, list, or restore notifications
