...
(setq doom-font (font-spec :family "Sarasa Term SC Nerd" :size 18 :weight 'Regular)
      ...
      doom-serif-font (font-spec :family "Noto Serif CJK SC" :size 18)
...
****** Key Binds
#+begin_src elisp :tangle no
(map! :leader :desc "Pomodoro" "t T" #'org-pomodoro)
(map! :leader :desc "Tidy Mode" "t t" #'org-tidy-mode)
#+end_src
**** Doc Mode
#+begin_src elisp :tangle packages/doom/.config/doom/config.el
