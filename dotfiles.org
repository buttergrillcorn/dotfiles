...
#+begin_src bash :tangle packages/hyprland/.local/bin/select-wallpaper.sh :shebang "#!/usr/bin/env bash"
set -euo pipefail
...
#+begin_src bash :tangle packages/sway/.local/bin/select-wallpaper.sh :shebang "#!/usr/bin/env bash"
set -euo pipefail
